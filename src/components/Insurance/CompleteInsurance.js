...
const CompleteInsurance = () => {
    ...
    const { booking_id, phone_number, amount_to_pay, first_name, last_name, contact_email } = location.state || {};

    const verifyPayment = async (transactionId) => {
        try {
            const response = await fetch(
                `${process.env.REACT_APP_API_URL}/insurance/payment-verification`,
                {
                    method: "POST",
    ...
    const fwConfig = {
        ...
        customizations: {
            title: 'Insurance Application Payment',
            description: 'Payment for insurance application',
    ...
    return (
        ...
        <div className="container d-flex flex-column align-items-center justify-content-center">
            <h2 className="mb-3">Insurance Application Payment</h2>
            <p className="text-center mb-4">You are about to make payment for your insurance processing, confirm your details below before proceeding to make payment.</p>
...
export default CompleteInsurance;
