...
const AddVisa = () => {
    ...
    const handleFileChange = (e) => {
        ...
        setFormData({ ...formData, visa_img: file || null });
    };
    ...
    const handleAddVisa = async (e) => {
        ...
        try {
            ...
            if (formData.visa_img) data.append('visa_img', formData.visa_img);
            ...
            <div className='container vw-100 vh-100 d-flex align-items-center justify-content-center flex-column gap-2'>
                ...
                <form onSubmit={handleAddVisa} className='p-4 shadow rounded d-flex flex-column gap-2 w-100'>
                    ...
                    <div className='d-flex flex-column gap-1'>
                        ...
                        <input type='number' name='service_charge' onChange={handleChange} className='border-0 bg-secondary-subtle rounded p-2 focus-0 rounded' />
                    </div>
                    <div className='d-flex flex-column gap-1'>
                    ...
                    <div className='d-flex flex-column gap-1'>
                        ...
                        <input type='file' name='visa_img' accept='image/*' onChange={handleFileChange} className='border-0 bg-secondary-subtle rounded p-2 focus-0 rounded' />
                    </div>
