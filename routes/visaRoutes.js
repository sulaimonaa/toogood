...
router.post("/bookings", upload.fields([
    ...
    try {
        ...
        db.query(sql, values, (err, result) => {
                    ...
                    <div style="padding: 20px; font-family: Arial, sans-serif; background-color: #f8f8f8; border-radius: 5px;">
                        ...
                        <div style="background-color: #fff; padding: 15px; border-radius: 5px; border: 1px solid #ddd;">
                            ...
                            <ul style="padding-left: 20px;">
                                ...
                                <li><strong>Travel Type:</strong> ${trip_type}</li>
                                <li><strong>Travel Period:</strong> ${coverage_begin} to ${coverage_end}</li>
                                <li><strong>Flight Details:</strong> ${flight_details}</li>
                                <li><strong>Hotel Details:</strong> ${hotel_details}</li>
                                <li><strong>Hotel Period:</strong> ${coverage_begin} to ${coverage_end}</li>
            ...
            res.json({ success: "Visa support booking application submitted successfully"});
        });
...
router.get('/visa-bookings', authenticateAdmin, (req, res) => {
